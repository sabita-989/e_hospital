            ...
            <div class="row">
                ...
                <nav class="col-sm-2 bg-light sidebar py-5 d-print-none">
                    <div class="sidebar-sticky">
                        ...
                        <li class="nav-item"><a class="nav-link <?php if(PAGE == 'notification') {echo 'active';} ?>" href="notification.php"><i class="fa fa-address-card"></i>&nbsp;My Appointment</a></li></ul>
                        <li class="nav-item"><a class="nav-link <?php if((PAGE == 'Appointment')||(PAGE == 'getappointment') ) {echo 'active';} ?>" href="Appointment.php"><i class="fab fa-accessible-icon"></i>&nbsp;Get Appointment</a></li></ul>
