            ...
            if ($count == 1) {
                while ($row = mysqli_fetch_assoc($result)) {
                    if (password_verify($rPassword, $row['r_password'])) {
                        ...
                        $msg = '<div class="alert alert-warning mt-2">Enter Valid Password</div>';
                    }
                }
            }else{
                $msg = '<div class="alert alert-warning mt-2">Enter Valid Email</div>';
            }
        }
    }
} else {
            ...
            <div class="col-sm-6 col-md-4">
                ...
                <form action="" class="shadow-lg p-4" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" placeholder="Email" value="<?php if (isset($_SESSION['rEmail'])) {
